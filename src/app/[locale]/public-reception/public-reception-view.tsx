...
import type { IPublicReceptionRequest } from "@my_types/counseling-types";
...
const PublicReceptionView = ({ translated }: IPublicReceptionViewProps) => {
	...
	return (
		<div className={styles.container}>
			...
			<HeroPages img_key="public-reception" title={translated.hero_title} />

			<WithAnimate type="both" to="up" triggerInView={false}>
